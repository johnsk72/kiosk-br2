                ...
                <div class="nav col m2 s2 xs2">
                 ...
                 <div class="col m10 s10 xs5">
                    <div class="row gutter">
                        ...
                        <div class="col m10 s10 xs12">
                            <a href="../pages/directory_namelist.php"><h2>Accountancy</h2></a>
                            <a href=""><h2>Actuarlial Science</h2></a>
                            <a href=""><h2>Advanced Studies</h2></a>
                            <a href=""><h2>Avdertising / Integrated Marketing Communications</h2></a>
                            <a href=""><h2>African American Studies</h2></a>
                            <a href=""><h2>Allied Health Studies</h2></a>
                            <a href=""><h2>Applied Mathematics</h2></a>
                            <a href=""><h2>Applied Speech</h2></a>
                            <a href=""><h2>Architecture</h2></a>
                            <a href=""><h2>Art History</h2></a>
                            <a href=""><h2>Automotive</h2></a>
                        </div>
                    </div>
                </div>
        	</div>
