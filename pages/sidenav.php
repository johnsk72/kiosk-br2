<nav>
    <ul>
        ...
        <a href="../pages/map.php"><li><img class="navicon" src="../images/map.svg" alt=""><h4>map</h4></li></a>
        <a href="../pages/academics.php"><li><img class="navicon" src="../images/academics.svg" alt=""><h4>academics</h4></li></a>
        <a href="../landing.php"><li><img class="navsmallicon" src="../images/home.svg" alt=""></li></a>
    </ul>
</nav>
