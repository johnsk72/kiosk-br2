            ...
            <div class="row gutter">
				...
				<div class="nav col m5 s5 xs5">
					...
					<div id="Accounting-Association" class="rso">
						<p><b>accountingassociation@ferris.edu</b></p>
